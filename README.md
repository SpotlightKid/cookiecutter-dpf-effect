...
Unless noed otherwise all files in this template are published under the
MIT License.
...
See the file [LICENSE](./LICENSE) for the terms of both license.

Project files generated by this template are either this licensed under the
